      ...
      <NuxtLink :to="productUrl">
        <div class="flex flex-col gap-2">
          ...
          <div>
            ...
            <!-- Diese Zeile ist die Gewichtsangabe ("ab 370g"). Ohne
                 hinterlegtes Gewicht stand hier ein sinnloses "0g"
                 beziehungsweise ein einsames "ab" — deshalb ganz
                 ausblenden. Das "ab" am Preis oben bleibt davon
                 unberührt. -->
            <div v-if="weightValue" class="mt-2 font-light text-muted">
              <span v-if="!withSingleVariant" class="pr-1">{{ $dict('web-app.cart.from') }}</span>
