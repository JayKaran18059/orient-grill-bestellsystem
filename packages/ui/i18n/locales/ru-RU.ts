export const ru: Dictionary = {
  ...
  'account': {
    ...
    'my-account-title': 'Мой аккаунт',
    'email-label': 'Электронная почта',
    'name-label': 'Имя',
    'continue-with-google': 'Продолжить через Google',
    'divider-or': 'или',
    'submit-register': 'Создать аккаунт',
    'switch-to-register': 'Впервые здесь? Создать аккаунт',
    'switch-to-login': 'Уже есть аккаунт? Войти',
    'order-history-title': 'Ваши заказы',
    'no-orders-yet': 'Пока нет заказов',
    'loyalty-title': 'Ваша карта лояльности',
    'loyalty-stamps-label': 'Собрано штампов',
    'loyalty-reward-available': 'Скидка 20% на следующий заказ (от 20 €) разблокирована!',
    'loyalty-next-reward-note': 'Каждые 6 заказов: скидка 20% на следующий заказ от 20 €',
  },
  'common': {
    'time': {
